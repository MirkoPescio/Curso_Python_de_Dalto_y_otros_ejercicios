...
final del curso (convocatoria ordinaria). Escribir un programa que contenga las siguientes 
funciones:
...
2) Una función que reciba una lista de diccionarios como la que devuelve la función anterior 
   ...
   El peso de cada parcial de teoría en la nota final es de un 30% mientras que el peso del 
