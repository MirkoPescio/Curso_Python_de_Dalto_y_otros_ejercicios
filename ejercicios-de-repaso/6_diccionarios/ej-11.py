...
otro diccionario con el resto de la información del cliente.
Los diccionarios con la información de cada cliente tendrán como claves los nombres
de los campos y como valores la información de cada cliente correspondientes a los
campos. Es decir, un diccionario como el siguiente

{'01234567L':
{'nombre': 'Luis González', 'email': 'luisgonzalez@mail.com', 'teléfono': '656343576',
'descuento': 12.5}, '71476342J': {'nombre': 'Macarena Ramírez', 'email':
'macarena@mail.com', 'teléfono': '692839321', 'descuento': 8.0}, '63823376M':
{'nombre': 'Juan José Martínez', 'email': 'juanjo@mail.com', 'teléfono': '664888233',
'descuento': 5.2}, '98376547F': {'nombre': 'Carmen Sánchez', 'email': 'carmen@mail.com',
...
while (ingreso.capitalize() != 'No'):
    print("Registro de datos: Nuevo Cliente")
    nif = input("Ingrese el Nif del cliente: ")
    nombre = input("Ingrese el nombre del cliente: ")
    email = input("Ingrese el e-mail del cliente: ")
    telefono = input("Ingrese el teléfono del cliente: ")
    descuento = float(input("Ingrese el porcentaje de descuento del cliente: "))
    while (descuento < 0):
        descuento = float(input("Ingrese un valor válido de descuento: "))
    dicc_principal[nif] = { 'Nombre': nombre, 'E-Mail': email, 'Teléfono': telefono, 'descuento': descuento }
    ingreso = input("¿Quiere seguir registrando clientes?: ")

print(dicc_principal)
"""
